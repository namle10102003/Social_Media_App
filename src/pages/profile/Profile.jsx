...
const Profile = () => {
    ...
    const mutation = useMutation({
        ...
        onSuccess: () => {
            // Invalidate and refetch relationship for this user
            ...
            {isLoading ? (
                ...
                <>
                    <div className="images">
                        <img src={data?.coverPic ? (data.coverPic.startsWith('http') || data.coverPic.startsWith('/') ? data.coverPic : '/upload/' + data.coverPic) : ''} alt="" className="cover" />
                        <img src={resolveProfilePic(data?.profilePic)} alt="" className="profilePic" />
                    </div>
